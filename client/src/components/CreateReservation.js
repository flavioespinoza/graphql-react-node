...
class CreateReservation extends React.Component {
	...
	_checkReservation () {
		this._createReservation(this.state.firstName, this.state.lastName, this.state.hotel, this.state.arrivalDateFormatted, this.state.departureDateFormatted)
	}
	...
	render () {
		...
		return (
			<section className={'form-reservation mt12'}>
				...
				<div className={'p12'}>
					...
					<section>
						...
						<label>
							First name:
							<TextField className={'mb12'} onChange={this._firstName}/>
						</label>

						<label>
							Last name
							<TextField className={'mb12'} onChange={this._lastName}/>
						</label>
